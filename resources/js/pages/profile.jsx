...
const Members = (props) => {
    ...
    const jabatan = props.data.jabatan ? props.data.jabatan.name : "";
    const isMember = jabatan === 'Member';
    console.log("props.data", props.data);
console.log("props.data.jabatan", props.data.jabatan);
            ...
            <div className="row">
                <div className="col col-md-4">
                    <div className="card">
                        ...
                        {props.data.foto && (
                            <img src={"/member/" + props.data.profile_pic} className="card-img-top" alt="..."></img>
                        )}
                        <div className="card-body">
                            <h5 className="card-title text-center">{props.data.name} - Foto Profil</h5>
                        </div>
                    </div>
                </div>
                {!isMember && (
                ...
                <div className="col col-md-8">
                    ...
                    <div className="mb-3">
                        ...
                        <input disabled className="form-control" value={props.data.job} />
                    </div>
                </div>
            </div>
            {!props.id && (
