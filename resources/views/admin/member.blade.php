                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="memberFoto" class="form-control d-none" name="foto" type="file" placeholder="Foto" required="required" accept="image/png, image/jpeg" onchange="onSelectFileChanged(this, 'fotoPlaceholder')" />
                        </div>
